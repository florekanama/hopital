...
// // // //         // Vérifier si la date est un jour de congé
...
// // // //         const jourSemaine = selectedDate.getDay() || 7
// // // //         const disposJour = disponibilitesMedecin.filter((d: any) => d.jour_semaine === jourSemaine && d.actif)
...
// // // //         const tousCreneaux: any[] = []
// // // //         const dureeRdv = 30 // minutes

// // // //         disposJour.forEach((dispo: any) => {
// // // //           const debut = new Date(selectedDate)
...
// // // //           let creneauDebut = new Date(debut)
          
// // // //           while (isBefore(addMinutes(creneauDebut, dureeRdv), fin)) {
// // // //             const creneauFin = addMinutes(creneauDebut, dureeRdv)
            
// // // //             // Vérifier si le créneau est pris
// // // //             const estPris = rendezVousExistants.some(rdv => {
// // // //               const rdvDebut = new Date(rdv.date_heure)
// // // //               const rdvFin = addMinutes(rdvDebut, rdv.duree_minutes)
              
// // // //               return (
// // // //                 (isBefore(creneauDebut, rdvFin) && isAfter(creneauFin, rdvDebut)) ||
// // // //                 isSameDay(creneauDebut, rdvDebut)
// // // //               )
// // // //             })

// // // //             if (!estPris) {
// // // //               tousCreneaux.push({
// // // //                 debut: new Date(creneauDebut),
// // // //                 fin: new Date(creneauFin),
// // // //                 lieu: dispo.lieu
// // // //               })
// // // //             }

// // // //             creneauDebut = addMinutes(creneauDebut, dureeRdv)
// // // //           }
// // // //         })

// // // //         setCreneauxDisponibles(tousCreneaux.sort((a, b) => a.debut - b.debut))
// // // //       } catch (error: any) {
// // // //         console.error('Erreur:', error)
// // // //         toast.error(`Erreur lors du calcul des créneaux: ${error.message}`)
// // // //       } finally {
// // // //         setLoading(false)
// // // //       }
// // // //     }
...
// // // //           <h1 className="text-3xl font-bold text-gray-900">Prendre un rendez-vous</h1>
// // // //           <p className="mt-2 text-lg text-gray-600">
// // // //             Sélectionnez un médecin et choisissez un créneau disponible
// // // //           </p>
// // // //         </div>
...
// // // //             <h2 className="text-xl font-semibold text-gray-800">1. Choisissez un médecin</h2>
...
// // // //           {selectedMedecin && (
// // // //             <div className="space-y-4">
// // // //               <h2 className="text-xl font-semibold text-gray-800">2. Choisissez une date</h2>
...
// // // //             <div className="space-y-4">
// // // //               <h2 className="text-xl font-semibold text-gray-800">3. Choisissez un créneau</h2>
...
// // // //           {selectedCreneau && (
// // // //             <div className="space-y-4">
// // // //               <h2 className="text-xl font-semibold text-gray-800">4. Détails du rendez-vous</h2>
...
// // // //               </svg>
// // // //               <h3 className="mt-2 text-lg font-medium text-yellow-800">Aucun créneau disponible</h3>
...
// //                     key={index}
// //                     type="button"
// //                     onClick={() => creneau.disponible && setSelectedCreneau(creneau.debut.toISOString())}
// //                     className={`p-3 border rounded-md text-center transition-colors ${
// //                       !creneau.disponible 
